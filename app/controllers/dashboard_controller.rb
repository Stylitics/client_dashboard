class DashboardController < ApplicationController
  ...
  def trends
    ...
    @chart_run[:color_opt] = "Include"
    @chart_run[:retailer_opt] = "Include"
    ...
    @chart_run[:start_date_txt] = Time.now.strftime("%Y-%m-%d")
    @chart_run[:end_date_txt] = 6.months.ago.strftime("%Y-%m-%d")
